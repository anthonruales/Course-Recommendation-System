...
batch24_ids = set(range(5146, 5166))
batch_qs = [q for q in QUESTIONS_POOL_ENHANCED if q["question_id"] in batch24_ids]
other_qs = [q for q in QUESTIONS_POOL_ENHANCED if q["question_id"] not in batch24_ids]
