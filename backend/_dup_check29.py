"""Batch 29 duplicate / rephrase checker — two independent methods."""
import re, sys
sys.path.insert(0, ".")
from data.questions_enhanced import QUESTIONS_POOL_ENHANCED as P

BATCH_IDS = set(range(5246, 5266))
...
if flags1 == 0 and flags2 == 0:
    print("\nBATCH 29 PASSED BOTH CHECKS — no duplicates or rephrases detected")
else:
    print(f"\nBATCH 29 NEEDS REVIEW — {flags1 + flags2} total flags")
