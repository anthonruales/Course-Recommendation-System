      ...
      {interestModalOpen && (
        <div style={styles.modalOverlay} onClick={() => setInterestModalOpen(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {(() => { const cats = new Set(selectedInterests.map(id => INTEREST_OPTIONS.find(o => o.id === id)?.category).filter(Boolean)); return cats.size >= 4 ? (
            <div style={{ padding: '10px 20px', background: 'rgba(234, 179, 8, 0.08)', borderBottom: '1px solid rgba(234, 179, 8, 0.15)', display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
              ...
              <p style={{ margin: 0, fontSize: '18px', color: 'rgba(234, 179, 8, 0.9)', lineHeight: '1.5' }}>
      ...
      {skillsModalOpen && (
        <div style={styles.modalOverlay} onClick={() => setSkillsModalOpen(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {(() => { const cats = new Set(selectedSkills.map(id => SKILL_OPTIONS.find(o => o.id === id)?.category).filter(Boolean)); return cats.size >= 4 ? (
            <div style={{ padding: '10px 20px', background: 'rgba(234, 179, 8, 0.08)', borderBottom: '1px solid rgba(234, 179, 8, 0.15)', display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
              <span style={{ fontSize: '14px', marginTop: '1px' }}>💡</span>
              <p style={{ margin: 0, fontSize: '18px', color: 'rgba(234, 179, 8, 0.9)', lineHeight: '1.5' }}>
