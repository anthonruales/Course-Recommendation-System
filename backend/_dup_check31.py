"""Duplicate / rephrase checker for Batch 31 against the entire existing pool."""
import sys, re
...
BATCH_IDS = set(range(5286, 5306))  # Q5286-Q5305
...
if flags1 == 0 and flags2 == 0:
    print('\nBATCH 31 PASSED BOTH CHECKS')
else:
    print(f'\nBATCH 31 HAS FLAGS: M1={flags1}, M2={flags2}')
